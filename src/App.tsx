...
import { Bell, ShieldCheck, Server, Activity } from 'lucide-react';
  ...
  return (
    <div className="w-screen h-screen bg-tech-radial bg-tech-grid text-white overflow-hidden font-sans relative flex flex-col">
      ...
      <header className="relative w-full h-[60px] md:h-[80px] shrink-0 flex items-center justify-between px-4 md:px-8 z-20">
        ...
        <div className="relative flex items-center gap-2 md:gap-4 w-1/4 md:w-1/3">
          <Clock />
        </div>
        ...
        <div className="relative flex items-center justify-end gap-3 md:gap-6 w-1/4 md:w-1/3 text-sm text-cyan-300">
          <div className="flex items-center gap-2 cursor-pointer hover:text-white transition-colors">
            <Bell size={20} className="icon-3d text-cyan-400" />
          </div>
          <div className="flex items-center gap-2 cursor-pointer hover:text-white transition-colors">
            <span className="px-3 md:px-4 py-1 md:py-1.5 rounded-full bg-cyan-900/50 border border-cyan-500/50 text-cyan-100 text-xs md:text-sm">
              Admin
            </span>
          </div>
        </div>
